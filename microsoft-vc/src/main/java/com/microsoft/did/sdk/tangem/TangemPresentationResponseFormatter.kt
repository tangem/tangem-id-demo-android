...
@Singleton
class TangemPresentationResponseFormatter @Inject constructor(
    ...
    fun formatResponse(
        ...
        val oidcResponseClaims = PresentationResponseClaims(
    ...
    private fun createAttestationsAndPresentationSubmission(
        ...
        val credentialPresentationSubmission =
            PresentationSubmission(credentialPresentationSubmissionDescriptors)
    ...
    private fun signContents(contents: PresentationResponseClaims, responder: Identifier): String {
        val serializedResponseContent =
            serializer.encodeToString(PresentationResponseClaims.serializer(), contents)
