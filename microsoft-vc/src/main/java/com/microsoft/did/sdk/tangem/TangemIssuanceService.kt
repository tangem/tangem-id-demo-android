        ...
        return runResultTry {
            logTime("Issuance getRequest") {
                ...
                val linkedDomainResult =
                    linkedDomainsService.fetchAndVerifyLinkedDomains(contract.input.issuer)
                        .abortOnError()
