...
@Singleton
class TangemPresentationService @Inject constructor(
    private val identifierManager: TangemIdentifierManager,
    ...
    private val presentationResponseFormatter: TangemPresentationResponseFormatter,
) {
        ...
        return runResultTry {
            logTime("Presentation getRequest") {
                ...
                val linkedDomainResult =
                    linkedDomainsService.fetchAndVerifyLinkedDomains(presentationRequestContent.issuer)
                        .abortOnError()
